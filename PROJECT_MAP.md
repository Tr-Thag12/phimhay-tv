...
- `server/src/routes/admin.routes.js`: Route admin chung, áp dụng `authMiddleware` và `requireAdmin`, mount `GET /api/admin/health` và `/api/admin/movies`.
